...
public static void main(String[] args) {
	...
	System.out.println("리스트에서 GDP가 20위 이내의 나라의 인구 총합은 " +sumOfPopulation+"벡만명이다.");
	Stream<Nation>s3=Nation.nations.stream();
	DoubleStream ds=s3.mapToDouble(Nation::getPopulation);
	DoubleSummaryStatistics dss=ds.summaryStatistics();// =IntSummaryStatistics();
